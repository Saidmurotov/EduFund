...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen fixed left-0 top-0 z-40 bg-[#0F172A] border-r border-slate-800 flex flex-col">
            {/* ── Logo ── */}
            <div className="px-5 py-6 flex items-center gap-3">
                ...
                <div className="min-w-0">
                    <div className="font-bold text-slate-50 text-[15px] leading-tight">
                        EduFund AI
                    </div>
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1 custom-scrollbar">
                <div className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.15em] px-3 mb-2">
                    Menu
                </div>
                    ...
                    className={({ isActive }) =>
                        [
                            ...
                            isActive
                                ...
                                : "text-amber-400/80 hover:bg-slate-800/70 hover:text-amber-300",
                        ].join(" ")
                    }
                >
                    <Crown
            ...
            <div className="px-3 py-4">
                <div className="flex items-center gap-3 px-3 py-3 rounded-xl bg-slate-800/40 border border-slate-800/60">
                    ...
                    <button
                        ...
                        title="Chiqish"
                        className="h-8 w-8 rounded-lg flex items-center justify-center text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 transition-colors shrink-0"
                    >
                        <LogOut size={16} />
                    </button>
                </div>
